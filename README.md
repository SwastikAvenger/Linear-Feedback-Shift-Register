...
The project is divided into four sections - design of a XOR Gate and design of a D-Flipflop [Sub Modules], design of a Shift Register and the topmod which combines all the sub-modules [Top Module]. 
